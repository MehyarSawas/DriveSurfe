...
@Component({
  ...
  imports: [FormsModule],
  template: `
    <div class="search-bar" [class.filter-active]="folderOnly()">
      ...
      @if (folderId() && folderId() !== '__trash__' && folderId() !== '__starred__') {
        <div class="filter-wrap">
          <button class="filter-btn" [class.active]="folderOnly()" (click)="toggleDropdown($event)" title="Filter search scope">
